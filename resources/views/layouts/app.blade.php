        ...
        <div class="flex items-start justify-between">
            <div class="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80">
                <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                    ...
                    <nav class="mt-6">
                        <div>
                            <a class="w-full font-thin uppercase text-green-600 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-green-100 dark:from-gray-700 dark:to-gray-800 border-r-4 border-green-500"
                               href="#">
